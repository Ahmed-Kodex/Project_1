...
export class AvatarSeeder {
  ...
  async run() {
    ...
    const data = [
      { id: 1, name: 'Denver', thumbnail: 'upload/avatars/Rectangle 28020.png' },
      ...
      { id: 5, name: 'Beckham', thumbnail: 'upload/avatars/Rectangle 28032.png' },
      { id: 6, name: 'Bree', thumbnail: 'upload/avatars/Rectangle 28028.png' },
      { id: 7, name: 'Hank', thumbnail: 'upload/avatars/Rectangle 28033.png' },
      { id: 8, name: 'Teagan', thumbnail: 'upload/avatars/Rectangle 28031.png' },
      ...
      { id: 12, name: 'Frida', thumbnail: 'upload/avatars/Rectangle 28024.png' },
      { id: 13, name: 'Parker', thumbnail: 'upload/avatars/Rectangle 28025.png' },
      { id: 14, name: 'Ivy', thumbnail: 'upload/avatars/Rectangle 28026.png' },
      { id: 15, name: 'Dylan', thumbnail: 'upload/avatars/Rectangle 28030.png' },
    ];
