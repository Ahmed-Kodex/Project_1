...
export class CreateProjectTable1765436421672 implements MigrationInterface {
  name = 'CreateProjectTable1765436421672';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`templates\` CHANGE \`deleted_at\` \`deleted_at\` timestamp(6) NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`audience\` DROP FOREIGN KEY \`FK_4960a4ab78d89b185e3d703b789\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`audience\` CHANGE \`userId\` \`userId\` int NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` DROP FOREIGN KEY \`FK_c8b27b9ebff86f1e1a4a110e201\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` DROP FOREIGN KEY \`FK_0f95914fd25b7a75bec08ff6b45\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` DROP FOREIGN KEY \`FK_8d3bf4c61658011646ac254c2e5\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` CHANGE \`audienceId\` \`audienceId\` int NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` CHANGE \`videoSpecId\` \`videoSpecId\` int NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` CHANGE \`avatarId\` \`avatarId\` int NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` CHANGE \`hookIds\` \`hookIds\` text NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` CHANGE \`script\` \`script\` text NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`audience\` ADD CONSTRAINT \`FK_4960a4ab78d89b185e3d703b789\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` ADD CONSTRAINT \`FK_c8b27b9ebff86f1e1a4a110e201\` FOREIGN KEY (\`audienceId\`) REFERENCES \`audience\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` ADD CONSTRAINT \`FK_0f95914fd25b7a75bec08ff6b45\` FOREIGN KEY (\`videoSpecId\`) REFERENCES \`video_specs\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` ADD CONSTRAINT \`FK_8d3bf4c61658011646ac254c2e5\` FOREIGN KEY (\`avatarId\`) REFERENCES \`avatars\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`projects\` CHANGE \`script\` \`script\` text NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` CHANGE \`hookIds\` \`hookIds\` text NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` CHANGE \`avatarId\` \`avatarId\` int NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` CHANGE \`videoSpecId\` \`videoSpecId\` int NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` CHANGE \`audienceId\` \`audienceId\` int NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`projects\` ADD CONSTRAINT \`FK_8d3bf4c61658011646ac254c2e5\` FOREIGN KEY (\`avatarId\`) REFERENCES \`avatars\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`audience\` CHANGE \`userId\` \`userId\` int NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`audience\` ADD CONSTRAINT \`FK_4960a4ab78d89b185e3d703b789\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`templates\` CHANGE \`deleted_at\` \`deleted_at\` timestamp(6) NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
