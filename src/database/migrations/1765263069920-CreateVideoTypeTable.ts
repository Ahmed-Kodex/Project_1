...
export class CreateVideoTypeTable1765263069920 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`video_specs\` CHANGE \`userId\` \`userId\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`video_type\` ADD CONSTRAINT \`FK_ee1590a55dfd4e44ed6e1cb8be2\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`products\` DROP FOREIGN KEY \`FK_1530a6f15d3c79d1b70be98f2be\``);
        await queryRunner.query(`ALTER TABLE \`products\` DROP FOREIGN KEY \`FK_99d90c2a483d79f3b627fb1d5e9\``);
        await queryRunner.query(`ALTER TABLE \`video_type\` DROP FOREIGN KEY \`FK_ee1590a55dfd4e44ed6e1cb8be2\``);
        await queryRunner.query(`ALTER TABLE \`brands\` DROP FOREIGN KEY \`FK_2bd14c9ce10e19d290d3f6818d9\``);
        ...
        await queryRunner.query(`ALTER TABLE \`video_specs\` CHANGE \`userId\` \`userId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`video_specs\` ADD CONSTRAINT \`FK_fe4a418c7d14b17e184a9cd125f\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
